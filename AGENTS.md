...
5. DLP (46 regex patterns for API keys/tokens + checksum validators + env var leak detection)
...
- **15 direct dependencies.** Don't suggest adding deps without strong justification.
