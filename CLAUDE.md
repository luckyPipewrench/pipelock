...
| Deps | 22 direct deps — run `make stats` for the live count. Core set: cobra, zerolog, go-readability, yaml.v3, goccy/go-yaml, prometheus, fsnotify, gobwas/ws, sentry-go, modernc.org/sqlite, otlp/proto, google/protobuf, go-landlock, cyclonedx-go, google/uuid, common-fate/httpsig (RFC 9421), dunglas/httpsfv (RFC 8941), plus x/crypto, x/net, x/sys, x/text, x/time. |
