...
| `file_sentry` | MCP | Whether every configured file_sentry watch subtree can be traversed by the current user, without installing watches. Strict incomplete coverage fails; best-effort incomplete coverage warns. |
