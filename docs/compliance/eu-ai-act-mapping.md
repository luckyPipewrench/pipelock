...
| GOVERN 2.1 | Roles and responsibilities for AI risk management | Per-agent profiles with listener binding or `source_cidrs` matching (network-bound), or header-based identification (self-declared/matched); HITL assigns human approval responsibility | Art. 14 |
