...
v2.6 review (May 2026): per-frame WS request_policy, allowlist_unparseable passthrough, media truncation, file_sentry block, header-DLP parity, submit SSRF-safe dial = Art.15/15(4)/15(5); Conductor enterprise+fleet-license gated, never inline.
