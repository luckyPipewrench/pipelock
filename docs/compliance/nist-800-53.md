...
**Gap:** Per-instance best-effort; durable fleet-level audit batching remains an enterprise roadmap item.
...
**Gap:** Fleet-wide configuration distribution and canary rollout are roadmap items; core has no fleet plane.
