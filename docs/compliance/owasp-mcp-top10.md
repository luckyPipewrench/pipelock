...
- **`pipelock claude hook` unknown-tool fail-closed default** on non-`PreToolUse` Claude Code hook events — **MCP02** (Privilege Escalation via Scope Creep) at the IDE-hook surface.
