...
```json
{
    ...
    "dockerfile_lines": [
        ...
        "RUN PIPELOCK_VERSION=0.2.5 && curl -fsSL https://github.com/luckyPipewrench/pipelock/releases/download/v${PIPELOCK_VERSION}/pipelock_${PIPELOCK_VERSION}_linux_amd64.tar.gz | tar xz -C /usr/local/bin/",
