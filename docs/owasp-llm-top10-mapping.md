...
- **DLP pattern matching:** 36 built-in patterns detect API keys, tokens, and credentials in outbound URLs and request bodies. Covers AWS, GCP, Azure, GitHub, Stripe, OpenAI, Anthropic, and 29 other providers.
