...
| SSRF to metadata/private networks | URL scanner SSRF layer after DLP/blocklist pre-resolution checks. Configured MCP upstream dialing allows local/private servers and still blocks cloud metadata endpoints. |
