...
func TestParseSemver(t *testing.T) {
	cases := []struct {
		...
		{"0.0.0-dev.unknown", true, [3]int{0, 0, 0}},
		{"0.0.0-dev.unknown.dirty", true, [3]int{0, 0, 0}},
		{"0.0.0-dev.unknown-date.g680cd0614d2e", true, [3]int{0, 0, 0}},
		{"0.0.0-dev.20260721.g680cd0614d2e", true, [3]int{0, 0, 0}},
		{"0.0.0-dev.20260721.g680cd0614d2e.dirty", true, [3]int{0, 0, 0}},
		{"unknown", false, [3]int{}},
		{"2.7", false, [3]int{}},
		{"a.b.c", false, [3]int{}},
		{"2.x.0", false, [3]int{}},
