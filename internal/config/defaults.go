...
// to an external markdown link.
const MarkdownLinkCredentialExfilRegex = `(?is)(?:(?:\b(?:send|upload|post|submit|paste|append|put|exfiltrat\w*|leak)\b.{0,80}\b(?:a[\s_-]*p[\s_-]*i[\s_-]*keys?|t[\s_-]*o[\s_-]*k[\s_-]*e[\s_-]*n[\s_-]*s?|s[\s_-]*e[\s_-]*c[\s_-]*r[\s_-]*e[\s_-]*t[\s_-]*s?|c[\s_-]*r[\s_-]*e[\s_-]*d[\s_-]*e[\s_-]*n[\s_-]*t[\s_-]*i[\s_-]*a[\s_-]*l[\s_-]*s?|p[\s_-]*a[\s_-]*s[\s_-]*s[\s_-]*w[\s_-]*o[\s_-]*r[\s_-]*d[\s_-]*s?|s[\s_-]*e[\s_-]*s[\s_-]*s[\s_-]*i[\s_-]*o[\s_-]*n[\s_-]*s[\s_-]*e[\s_-]*c[\s_-]*r[\s_-]*e[\s_-]*t[\s_-]*s?)\b(?:[^\n.!?]|\.\S){0,80}\b(?:to|into|onto|in|at|via|using|through|here|there)\b\s*(?:the\s+following\s+|(?:(?:this|that|our|my|their|a|an|the)\s+)?(?:(?:secure|external|collection|upload|remote)\s+)*(?:link|url|endpoint|server|form|page|address)\b\s*[:,-]?\s*)?|\b(?:collect|copy|include)\b.{0,80}\b(?:a[\s_-]*p[\s_-]*i[\s_-]*keys?|t[\s_-]*o[\s_-]*k[\s_-]*e[\s_-]*n[\s_-]*s?|s[\s_-]*e[\s_-]*c[\s_-]*r[\s_-]*e[\s_-]*t[\s_-]*s?|c[\s_-]*r[\s_-]*e[\s_-]*d[\s_-]*e[\s_-]*n[\s_-]*t[\s_-]*i[\s_-]*a[\s_-]*l[\s_-]*s?|p[\s_-]*a[\s_-]*s[\s_-]*s[\s_-]*w[\s_-]*o[\s_-]*r[\s_-]*d[\s_-]*s?|s[\s_-]*e[\s_-]*s[\s_-]*s[\s_-]*i[\s_-]*o[\s_-]*n[\s_-]*s[\s_-]*e[\s_-]*c[\s_-]*r[\s_-]*e[\s_-]*t[\s_-]*s?)\b(?:[^\n.!?]|\.\S){0,120}\b(?:send|upload|post|submit|paste|append|put|exfiltrat\w*|leak)\b(?:[^\n.!?]|\.\S){0,80}\b(?:to|into|onto|in|at|via|using|through|here|there)\b\s*(?:the\s+following\s+|(?:(?:this|that|our|my|their|a|an|the)\s+)?(?:(?:secure|external|collection|upload|remote)\s+)*(?:link|url|endpoint|server|form|page|address)\b\s*[:,-]?\s*)?)(?:\[[^\n]{1,160}\]\(\s*https?://[^)\s]+|<\s*https?://[^>\s]+>|\[[^\n]{1,160}\]\s*\[[^\]\n]{1,80}\](?:[^\n]|\n[ \t]*){0,240}\[[^\]\n]{1,80}\]:\s*https?://[^\s]+)|(?:\[[^\n]{1,160}\]\(\s*https?://[^)\s]+|<\s*https?://[^>\s]+>|\[[^\n]{1,160}\]\s*\[[^\]\n]{1,80}\](?:[^\n]|\n[ \t]*){0,240}\[[^\]\n]{1,80}\]:\s*https?://[^\s]+)(?:[^\n.!?]|\.\S){0,80}\bto\s+(?:upload|post|submit|exfiltrat\w*|leak)\b.{0,80}\b(?:a[\s_-]*p[\s_-]*i[\s_-]*keys?|t[\s_-]*o[\s_-]*k[\s_-]*e[\s_-]*n[\s_-]*s?|s[\s_-]*e[\s_-]*c[\s_-]*r[\s_-]*e[\s_-]*t[\s_-]*s?|c[\s_-]*r[\s_-]*e[\s_-]*d[\s_-]*e[\s_-]*n[\s_-]*t[\s_-]*i[\s_-]*a[\s_-]*l[\s_-]*s?|p[\s_-]*a[\s_-]*s[\s_-]*s[\s_-]*w[\s_-]*o[\s_-]*r[\s_-]*d[\s_-]*s?|s[\s_-]*e[\s_-]*s[\s_-]*s[\s_-]*i[\s_-]*o[\s_-]*n[\s_-]*s[\s_-]*e[\s_-]*c[\s_-]*r[\s_-]*e[\s_-]*t[\s_-]*s?)\b|(?:\[[^\n]{1,160}\]\(\s*https?://[^)\s]+|<\s*https?://[^>\s]+>|\[[^\n]{1,160}\]\s*\[[^\]\n]{1,80}\](?:[^\n]|\n[ \t]*){0,240}\[[^\]\n]{1,80}\]:\s*https?://[^\s]+)(?:[^\n.!?]|\.\S){0,120}\b(?:send|upload|post|submit|paste|append|put|exfiltrat\w*|leak)\b.{0,80}\b(?:a[\s_-]*p[\s_-]*i[\s_-]*keys?|t[\s_-]*o[\s_-]*k[\s_-]*e[\s_-]*n[\s_-]*s?|s[\s_-]*e[\s_-]*c[\s_-]*r[\s_-]*e[\s_-]*t[\s_-]*s?|c[\s_-]*r[\s_-]*e[\s_-]*d[\s_-]*e[\s_-]*n[\s_-]*t[\s_-]*i[\s_-]*a[\s_-]*l[\s_-]*s?|p[\s_-]*a[\s_-]*s[\s_-]*s[\s_-]*w[\s_-]*o[\s_-]*r[\s_-]*d[\s_-]*s?|s[\s_-]*e[\s_-]*s[\s_-]*s[\s_-]*i[\s_-]*o[\s_-]*n[\s_-]*s[\s_-]*e[\s_-]*c[\s_-]*r[\s_-]*e[\s_-]*t[\s_-]*s?)\b(?:[^\n.!?]|\.\S){0,80}\b(?:here|there)\b)` // #nosec G101 -- detection regex: contains credential nouns to MATCH exfiltration instructions, not a hardcoded credential
