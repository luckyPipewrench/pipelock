...
var defaultDLPPatternSet = []DLPPattern{
	...
	{Name: "GitLab PAT", Regex: `glpat-[a-zA-Z0-9\-_]{20,}`, Severity: SeverityCritical, CredentialAudienceHosts: []string{"gitlab.com"}, CredentialAudienceCarrierMask: gitlabTokenAudienceMask},
