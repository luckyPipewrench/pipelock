...
func TestClassifyTool(t *testing.T) {
	...
	tests := []struct {
		...
		{"MCP namespaced terminal", "mcp__shell__terminal", "exec"},
		{"dot namespaced write", "filesystem.write_file", "write"},
		{"colon namespaced write", "filesystem:write_file", "write"},
		{"namespace action retains keyword priority", "terminal.read_file", "exec"},
		{"malformed namespace keeps keyword fallback", "mcp__filesystem__write_file__extra", "write"},
