...
func fwdScannedInput(r io.Reader, w io.Writer, logW io.Writer, sc *scanner.Scanner, action, onParseError string, blockedCh chan<- BlockedRequest) {
	ForwardScannedInput(transport.NewStdioReader(r), transport.NewStdioWriter(w), logW, sc, action, onParseError, blockedCh, nil, nil, nil, nil, nil, nil, nil, nil, nil)
}
...
func TestForwardScannedInput_PolicyBlocksDangerousToolCall(t *testing.T) {
	...
	ForwardScannedInput(transport.NewStdioReader(clientIn), transport.NewStdioWriter(&serverIn), &logW, sc, "block", "block", blockedCh, policyCfg, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestForwardScannedInput_PolicyNilPassthrough(t *testing.T) {
	...
	clientIn := strings.NewReader(req)
	ForwardScannedInput(transport.NewStdioReader(clientIn), transport.NewStdioWriter(&serverIn), &logW, sc, "warn", "block", blockedCh, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestForwardScannedInput_InjectionInToolArgs(t *testing.T) {
	...
	ForwardScannedInput(transport.NewStdioReader(strings.NewReader(msg)), transport.NewStdioWriter(&serverBuf), &logBuf, sc, "block", "block", blockedCh, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestForwardScannedInput_SessionBinding_BlockUnknown(t *testing.T) {
	...
	ForwardScannedInput(
		...
		&logBuf, sc, "warn", "block", blockedCh, nil, bindingCfg, nil, nil, nil, nil, nil, nil, nil,
	)
...
func TestForwardScannedInput_KillSwitchBlocksRequest(t *testing.T) {
	...
	go ForwardScannedInput(clientReader, serverWriter, &logBuf, sc, "block", "block", blockedCh, nil, nil, ks, nil, nil, nil, nil, nil, nil)
...
func TestForwardScannedInput_ChainDetectionBlock(t *testing.T) {
	...
	go ForwardScannedInput(clientReader, serverWriter, &logBuf, sc, "warn", "block", blockedCh, nil, nil, nil, cm, nil, nil, nil, nil, nil)
...
func TestForwardScannedInput_ChainDetectionBlock_WithAuditLogger(t *testing.T) {
	...
	go ForwardScannedInput(clientReader, serverWriter, &logBuf, sc, "warn", "block", blockedCh, nil, nil, nil, cm, nil, al, nil, nil, nil)
...
func TestForwardScannedInput_CEEBlocksCleanMessage(t *testing.T) {
	...
	ForwardScannedInput(
		...
		nil, nil, nil, nil, nil, logger, cee, nil, nil,
	)
