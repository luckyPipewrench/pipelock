...
func TestRunProxy_CleanPassthrough(t *testing.T) {
	...
	err := RunProxy(context.Background(), strings.NewReader(""), &out, logBuf, []string{"echo", cleanResponse}, sc, nil, nil, nil, nil, nil)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestRunProxy_BlocksInjection(t *testing.T) {
	...
	err := RunProxy(context.Background(), strings.NewReader(""), &out, logBuf, []string{"echo", injectionResponse}, sc, nil, nil, nil, nil, nil)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestRunProxy_AskAction(t *testing.T) {
	...
	err := RunProxy(context.Background(), strings.NewReader(""), &out, logBuf, []string{"echo", injectionResponse}, sc, approver, nil, nil, nil, nil)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestRunProxy_InputScanningBlocksDirtyRequest(t *testing.T) {
	...
	err := RunProxy(context.Background(), strings.NewReader(dirtyReq), &out, logBuf, []string{"echo", cleanResponse}, sc, nil, inputCfg, nil, nil, nil)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestRunProxy_InputScanningForwardsCleanRequest(t *testing.T) {
	...
	err := RunProxy(context.Background(), strings.NewReader(cleanReq), &out, logBuf, []string{"echo", cleanResponse}, sc, nil, inputCfg, nil, nil, nil)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestRunProxy_InvalidCommand(t *testing.T) {
	...
	err := RunProxy(context.Background(), strings.NewReader(""), &out, logBuf, []string{"/nonexistent/binary"}, sc, nil, nil, nil, nil, nil)
	if err == nil {
...
func TestRunProxy_ContextCancel(t *testing.T) {
	...
	_ = RunProxy(ctx, strings.NewReader(""), &out, logBuf, []string{"cat"}, sc, nil, nil, nil, nil, nil)
}
...
func TestRunProxy_ScanWriteError(t *testing.T) {
	...
	err := RunProxy(context.Background(), strings.NewReader(""), w, logBuf, []string{"echo", cleanResponse}, sc, nil, nil, nil, nil, nil)
	if err == nil {
...
func TestRunProxy_WithToolConfig(t *testing.T) {
	...
	err := RunProxy(context.Background(), strings.NewReader(""), &out, logBuf, []string{"echo", cleanResponse}, sc, nil, nil, toolCfg, nil, nil)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestRunProxy_InputScanningBlocksNotification(t *testing.T) {
	...
	err := RunProxy(context.Background(), strings.NewReader(notification), &out, logBuf, []string{"echo", cleanResponse}, sc, nil, inputCfg, nil, nil, nil)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestRunProxy_ExtraEnvPassedToChild(t *testing.T) {
	...
	err := RunProxy(context.Background(), strings.NewReader(""), &out, logBuf, []string{"sh", "-c", script}, sc, nil, nil, nil, nil, nil, "MY_CUSTOM_VAR=hello_from_pipelock")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestRunProxy_ExtraEnvDoesNotLeakWithout(t *testing.T) {
	...
	_ = RunProxy(context.Background(), strings.NewReader(""), &out, logBuf, []string{"env"}, sc, nil, nil, nil, nil, nil)
...
func TestRunProxy_PolicyBlocksDangerousToolCall(t *testing.T) {
	...
	err := RunProxy(context.Background(), strings.NewReader(req), &out, logBuf, []string{"echo", cleanResponse}, sc, nil, inputCfg, nil, policyCfg, nil)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestRunProxy_PolicyOnlyWithoutInputScanning(t *testing.T) {
	...
	err := RunProxy(context.Background(), strings.NewReader(req), &out, logBuf, []string{"echo", cleanResponse}, sc, nil, nil, nil, policyCfg, nil)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
