...
func TestRunWSProxy_ForwardsCleanRequest(t *testing.T) {
	...
	go func() {
		defer wg.Done()
		proxyErr = RunWSProxy(ctx, pr, &stdout, &stderr, wsURL(srv), sc, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	}()
...
func TestRunWSProxy_InputDLPBlocking(t *testing.T) {
	...
	err := RunWSProxy(ctx, stdin, &stdout, &stderr, wsURL(srv), sc, nil, inputCfg, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	if err != nil {
...
func TestRunWSProxy_KillSwitchDeniesAll(t *testing.T) {
	...
	err := RunWSProxy(ctx, stdin, &stdout, &stderr, wsURL(srv), sc, nil, nil, nil, nil, ks, nil, nil, nil, nil, nil, nil, nil)
	if err != nil {
		t.Fatalf("RunWSProxy: %v", err)
	}
...
func TestRunWSProxy_ToolPolicyBlocks(t *testing.T) {
	...
	err := RunWSProxy(ctx, stdin, &stdout, &stderr, wsURL(srv), sc, nil, inputCfg, nil, policyCfg, nil, nil, nil, nil, nil, nil, nil, nil)
	if err != nil {
		t.Fatalf("RunWSProxy: %v", err)
	}
...
func TestRunWSProxy_ChainDetectionBlocks(t *testing.T) {
	...
	go func() {
		defer wg.Done()
		proxyErr = RunWSProxy(ctx, pr, &stdout, &stderr, wsURL(srv), sc, nil, inputCfg, nil, nil, nil, chainMatcher, nil, nil, nil, nil, nil, nil)
	}()
...
func TestRunWSProxy_InputDLPWithAuditLogger(t *testing.T) {
	...
	err := RunWSProxy(ctx, stdin, &stdout, &stderr, wsURL(srv), sc, nil, inputCfg, nil, nil, nil, nil, al, nil, nil, nil, nil, nil)
	if err != nil {
		t.Fatalf("RunWSProxy: %v", err)
	}
...
func TestRunWSProxy_ToolScanningDetectsPoison(t *testing.T) {
	...
	go func() {
		defer wg.Done()
		proxyErr = RunWSProxy(ctx, pr, &stdout, &stderr, wsURL(srv), sc, nil, nil, toolCfg, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	}()
...
func TestRunWSProxy_DialFailure(t *testing.T) {
	...
	err := RunWSProxy(ctx, stdin, &stdout, &stderr, "ws://127.0.0.1:1", sc, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	if err == nil {
...
func TestRunWSProxy_UpstreamCloseReturnsCleanly(t *testing.T) {
	...
	_ = RunWSProxy(ctx, stdin, &stdout, &stderr, wsURL(srv), sc, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
}
...
func TestRunWSProxy_InputScanWarnMode(t *testing.T) {
	...
	go func() {
		defer wg.Done()
		proxyErr = RunWSProxy(ctx, pr, &stdout, &stderr, wsURL(srv), sc, nil, inputCfg, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	}()
...
func TestRunWSProxy_UpstreamWriteError(t *testing.T) {
	...
	go func() {
		...
		_ = RunWSProxy(ctx, pr, &stdout, &stderr, wsURL(srv), sc, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	}()
...
func TestRunWSProxy_ParentContextCancellation(t *testing.T) {
	...
	go func() {
		defer wg.Done()
		runErr = RunWSProxy(ctx, pr, &stdout, &stderr, wsURL(srv), sc, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	}()
...
func TestRunWSProxy_StdinReadError(t *testing.T) {
	...
	err := RunWSProxy(ctx, &errReaderWS{err: customErr}, &stdout, &stderr, wsURL(srv), sc, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	if err == nil {
