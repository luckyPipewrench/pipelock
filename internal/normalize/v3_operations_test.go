...
func TestV3RecipeOperations(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"v1 rejects strict empty alphabet", EvidenceProvenanceProfileV1Digest, `[{"kind":"base32_decode","alphabet":""}]`, "MFRGG", "", "unknown base32 alphabet"},
		{"v2 rejects strict empty alphabet", EvidenceProvenanceProfileV2Digest, `[{"kind":"base32_decode","alphabet":""}]`, "MFRGG", "", "unknown base32 alphabet"},
		{"v3 rejects strict empty alphabet", v3, `[{"kind":"base32_decode","alphabet":""}]`, "MFRGG", "", "unknown base32 alphabet"},
