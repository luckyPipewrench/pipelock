...
func TestAnalyticsRelayRejectsUnboundedOrMalformedInput(t *testing.T) {
	...
	tests := []struct {
		...
		{"case_folded_event_alias", `{"event":"attacker_first","Event":"playground_live_session_started","properties":{}}`},
		{"duplicate_properties", `{"event":"playground_live_session_started","properties":{"prompt":"hidden"},"properties":{}}`},
		{"case_folded_properties_alias", `{"event":"playground_live_session_started","Properties":{}}`},
