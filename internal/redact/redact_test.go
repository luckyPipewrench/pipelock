...
func TestRedactor_BuiltInClassesFormatCorrectly(t *testing.T) {
	...
	classes := []Class{
		...
		ClassVercelToken, ClassDatabricksPAT, ClassOpenAIAPIKey,
		ClassAnthropicKey, ClassNPMToken, ClassPyPIToken, ClassNotionAPIKey,
		ClassTelegramToken, ClassDiscordToken, ClassJWT,
