		...
		Controls: []ControlMapping{
			{
				...
				Features: []string{featureDiscover, featureDLP},
			...
			},
			{
				...
				Status:   StatusCovered,
				Features: []string{featureSimulate, featureAssess, featureFlightRecorder},
			...
			},
			{
				...
				Status:   StatusCovered,
				Features: []string{featureDLP, featureResponseScanning},
			...
			},
			{
				...
				Status:   StatusCovered,
				Features: []string{featureResponseScanning, featureToolPolicy},
			...
			},
			{
				...
				Status:   StatusCovered,
				Features: []string{featureSimulate},
			...
			},
			{
				...
				Status:   StatusCovered,
				Features: []string{featureResponseScanning},
			...
			},
			{
				...
				Features:   []string{featureResponseScanning, featureSimulate, featureAttestation},
			...
			},
			{
				...
				Status:     StatusPartial,
				Features:   []string{featureAttestation, featureAssess},
			...
			},
			{
				...
				Status:     StatusPartial,
				Features:   []string{featureResponseScanning, featureDiscover, featureSimulate},
			...
			},
			{
				...
				Status:   StatusCovered,
				Features: []string{featureToolPolicy, featureMCPToolPolicy, featureDLP},
			...
			},
			{
				...
				Status:     StatusPartial,
				Features:   []string{featureFlightRecorder, featureAttestation, featureHITL},
