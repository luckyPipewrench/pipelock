		...
		Controls: []ControlMapping{
			{
				...
				Features: []string{featureDLP, featureEnvLeak, featureCanaryTokens},
			...
			},
			{
				...
				Status:   StatusCovered,
				Features: []string{featureAgents, featureSessionProfiling, featureToolPolicy},
			...
			},
			{
				...
				Name:     "Tool Poisoning",
				Status:   StatusCovered,
				Features: []string{featureMCPToolScanning, featureMCPToolProvenance, featureBehavioralBaseline},
			...
			},
			{
				...
				Status:   StatusCovered,
				Features: []string{featureMCPToolPolicy, featureSandbox},
			...
			},
			{
				...
				Status:   StatusCovered,
				Features: []string{featureFlightRecorder, featureEmit, featureMetrics},
			...
			},
			{
				...
				Status:   StatusCovered,
				Features: []string{featureResponseScanning, featureMCPInputScanning, featureFlightRecorder},
