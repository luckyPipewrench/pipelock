...
func (fb *FragmentBuffer) appendLocked(streamKey string, payload []byte) FragmentAppendResult {
...
// AppendPathSegmentsForSession appends a position-aware stream.
